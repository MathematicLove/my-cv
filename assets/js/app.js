(function () {
  ...
  const meta = {
    ru: {
      ...
      authorBio: 'Junior ML-engineer. Магистр 1-го курса (предварительно зачислен), СПбПУ, ИКНК. Математика и компьютерные науки, машинное обучение и искусственный интеллект.',
    ...
    en: {
      ...
      authorBio: "Junior ML-engineer. 1st-year master's student (preliminary enrollment), SPbSTU, ICCS. Mathematics and Computer Science, Machine Learning and Artificial Intelligence.",
