...
- Салимли Айзек - магистр СПбПУ (ИКНК), направление Математика и компьютерные науки: машинное обучение и искусственный интеллект. Имею 1 год и 5 месяцев опыта в The Blooms Bridge: интеграция ИИ-систем (RAG, computer vision и др.) и backend-разработка. В первую очередь позиционирусь как Junior ML Engineer и работаю с ML-циклом: предобработка и трансформация данных, анализ данных, отбор признаков, обучение моделей, подбор гиперпараметров, интерпретация результатов, разметка данных, обучение LLM, построение моделей (PyTorch, TensorFlow), внедрение (LangChain + LangGraph) и задачи компьютерного зрения (YOLO, ResNet, SegFormer, YOLO-seg).
